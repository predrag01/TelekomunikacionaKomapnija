...
{
	partial class PotvrdiBrisanjePlacanjaForma
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "PotvrdiBrisanjePlacanjaForma";
			this.Text = "PotvrdiBrisanjePlacanjaForma";
			this.Load += new System.EventHandler(this.PotvrdiBrisanjePlacanjaForma_Load);
