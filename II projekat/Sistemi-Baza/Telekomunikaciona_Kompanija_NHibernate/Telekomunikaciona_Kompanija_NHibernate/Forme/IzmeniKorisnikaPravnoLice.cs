...
{
    public partial class IzmeniKorisnikaPravnoLice : Form
    {
        ...
        Pravna_licaBasic korisnik_Basic;
        string jmbg;
        public IzmeniKorisnikaPravnoLice()
        {
            InitializeComponent();

        }
        public IzmeniKorisnikaPravnoLice(KorisnikBasic ub)
        {
            InitializeComponent();
            ...
            jmbg = ub.JMBG;
            Pravna_licaBasic lice = DTOmanagerM.vratiPravnoLiceBasic(ub.JMBG);
        ...
        public void popuniPodacima()
        {
            ...
            ImeKontaktOsobeTB.Text = korisnik_Basic.Ime_kontakt_osobe;
            BrojFaksaNum.Value = korisnik_Basic.Broj_faksa;
            PoreskiBrojNum.Value = korisnik_Basic.Poreski_identifikacioni_broj;
        ...
        private void IzmeniKorisnikaPravnoLice_Load(object sender, EventArgs e)
        {
        ...
        private void SacuvajBtn_Click(object sender, EventArgs e)
        {
            ...
            if (String.Compare(ImeKontaktOsobeTB.Text, korisnik_Basic.Prezime) != 0 && !String.IsNullOrEmpty(ImeKontaktOsobeTB.Text) && !String.IsNullOrWhiteSpace(ImeKontaktOsobeTB.Text))
            {
                korisnik_Basic.Ime_kontakt_osobe = ImeKontaktOsobeTB.Text;
            }

            if(BrojFaksaNum.Value!=0 && BrojFaksaNum.Value != korisnik_Basic.Broj_faksa)
            {
                korisnik_Basic.Broj_faksa = (long)BrojFaksaNum.Value;
            }

            if (PoreskiBrojNum.Value != 0 && PoreskiBrojNum.Value != korisnik_Basic.Poreski_identifikacioni_broj)
            {
                korisnik_Basic.Poreski_identifikacioni_broj = (long)PoreskiBrojNum.Value;
            }

            if (BrojNum.Value != 0 && BrojNum.Value != decimal.Parse(korisnik_Basic.Broj))
            {
                korisnik_Basic.Broj=BrojNum.Value.ToString();
            }

            DTOmanagerM.promeniKorisnikaPravnoLice(korisnik_Basic);
