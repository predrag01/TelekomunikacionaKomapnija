...
{
	partial class PotvrdiBrisanjeTelevizijeForma
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// 
			// PotvrdiBrisanjeTelevizijeForma
			// 
			...
			this.Name = "PotvrdiBrisanjeTelevizijeForma";
			this.Text = "PotvrdiBrisanjeTelevizijeForma";
			this.Load += new System.EventHandler(this.PotvrdiBrisanjeTelevizijeForma_Load);
