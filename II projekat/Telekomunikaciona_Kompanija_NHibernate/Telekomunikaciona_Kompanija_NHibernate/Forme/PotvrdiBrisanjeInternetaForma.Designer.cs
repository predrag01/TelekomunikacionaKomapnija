...
{
	partial class PotvrdiBrisanjeInternetaForma
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "PotvrdiBrisanjeInternetaForma";
			this.Text = "PotvrdiBrisanjeForma";
			this.Load += new System.EventHandler(this.PotvrdiBrisanjeForma_Load);
