...
{
	partial class PotvdraBrisanjaDodatnogPaketaForma
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// 
			// PotvdraBrisanjaDodatnogPaketaForma
			// 
			...
			this.Name = "PotvdraBrisanjaDodatnogPaketaForma";
			this.Text = "PotvdraBrisanjaDodatnogPaketaForma";
			this.Load += new System.EventHandler(this.PotvdraBrisanjaDodatnogPaketaForma_Load);
